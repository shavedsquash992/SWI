...
echo "bamcpo".$dbname."criaco bmom";}
catch(PDOException $th){}
?>
<form action="criartabela.php" method="post">
    <input type="text" name="tabela" id="tabela" placeholder="Nome da Tabela">
    <input type="text" name="campo" id="campo" placeholder="Coluna 1">
    <input type="text" name="campo2" id="campo2" placeholder="Coluna 2">
    <input type="text" name="tipo" id="tipo" placeholder="INT(11)">
